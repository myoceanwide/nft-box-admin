                ...
                <div class="detail-cont">
                  <div class="detail01">
                    ...
                    <div class="text-width">
                      <span>配送方式：快递发货</span>
                      <span class="revise-addr" onclick="window.location.href='#'"><img src="~@/assets/img/revise.png"
                          alt="">修改地址</span>
                      <br>
              ...
              <div class="buyers">
                ...
                <div class="buyers-info">
                  <div class="detail02">
                    ...
                    <div class="text-width">
                      <span>买家备注：</span>
                      <span class="revise-remarks" onclick="window.location.href='#'"><img
                          src="~@/assets/img/revise.png" alt="">修改备注</span>
                      <br>
