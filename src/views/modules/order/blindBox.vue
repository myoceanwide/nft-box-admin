<template>
  <div class="mod-prod">
    <avue-crud ref="crud" :page.sync="page" :data="dataList" :search.sync="search" :table-loading="dataListLoading" :option="tableOption"
      ...
      </template>      <!-- <template slot-scope="scope" slot="orderStatus">
...
<script>
import AddOrUpdate from './blindBoxInfo'
import { tableOption } from '@/crud/order/blindBox'
...
export default {
  ...
  methods: {
    ...
    searchChange (params, done) {
      console.log(params, '321312312321')
