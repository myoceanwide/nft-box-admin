  ...
  <el-dialog :title="!dataForm.id ? '新增' : '修改'" :close-on-click-modal="false" :visible.sync="visible">
    <el-form :model="dataForm" :rules="dataRule" ref="dataForm" @keyup.enter.native="dataFormSubmit()"
      ...
      <el-form-item label="创建时间" prop="createTime">
        <el-date-picker v-model="dataForm.createTime" type="datetime" placeholder="选择日期"
      ...
      <el-form-item label="留言内容" prop="content">
        <tiny-mce v-model="dataForm.content" ref="content"></tiny-mce>
      </el-form-item>
      <el-form-item label="留言回复" prop="reply">
        <tiny-mce v-model="dataForm.reply" ref="reply"></tiny-mce>
      </el-form-item>
